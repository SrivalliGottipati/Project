...
class HomeGetter extends StatefulWidget {
  HomeGetter({super.key});
  late String value;

  @override
  State<HomeGetter> createState() => _HomeGetterState();
}

class _HomeGetterState extends State<HomeGetter> {
  ...
  Future<void> home_gettr() async {
    try {
      const String url =
          'https://newsapi.org/v2/top-headlines?language=en&from=2024-08-15&to=2024-08-25&sortBy=publishedAt&apiKey=c5c9dfe1d21245f5bcf1d191d176b537';
